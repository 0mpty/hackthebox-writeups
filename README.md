...
> ⚠️ **Important Notice:** The materials, scripts, and descriptions provided in this repository are for **educational and research purposes only**. 
...
* **No Direct Flag Sharing:** Actual final flags (`HTB{...}`) are deliberately redacted or hidden under spoiler tags.
* **Methodology Over Copy-Pasting:** The goal of these writeups is to explain *how* to find the solution, not to give away the answer.
