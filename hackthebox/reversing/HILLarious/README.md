...
We see two function: `FUN_001017b0` and `FUN_00101680`. The function `FUN_001017b0` just take a text and write in `pvVar2`. The function `FUN_00101680` decrypt text. We also have `local_70 - lenght of text`, `local_58 - main constant` and `local_54 - time`(Do not forget the local_54. We need it in neer future!!!).
